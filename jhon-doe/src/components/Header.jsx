...
const Header = () => {
  return (
    <div className="w-full lg:h-[63px] sm:h-[55px] h-[56px] justify-between flex items-center  lg:px-16 sm:px-10 px-6  lg:text-[16px] text-[12px] font-[700] lg:leading-[22px] leading-[16px] sm:shadow-none shadow-header text-primary-text dark:text-gray-10">
      <HeaderLogo />
